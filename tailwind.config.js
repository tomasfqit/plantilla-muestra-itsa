...
export default {
  ...
  theme: {
    extend: {
      ...
      // Spacing System (Gap, Margin, Padding)
      spacing: {
        '0': '0px',
        'px': '1px',
        '0.5': '2px',
      ...
      colors: {
        ...
        // Semantic Colors (existing system)
      ...
      fontSize: {
        ...
        'display-sm': ['30px', { lineHeight: '1.3', letterSpacing: '-0.01em' }],
        ...
        'h5': ['18px', { lineHeight: '1.4', letterSpacing: '-0.01em' }],
        ...
        // Caption sizes
        'caption-lg': ['14px', { lineHeight: '1.5', letterSpacing: '0.01em' }],
        'caption-md': ['12px', { lineHeight: '1.5', letterSpacing: '0.01em' }],
        'caption-sm': ['11px', { lineHeight: '1.5', letterSpacing: '0.01em' }],
